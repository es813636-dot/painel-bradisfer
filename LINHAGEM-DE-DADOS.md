...
| `listarVendasPorVendedor` | `automacao-vendas/atualizar-vendas-online.js` (GitHub Actions, só empresas 3/4 — marketplace) | A cada 5 min (v2, incremental por checkpoint — pedido era 3 min, piso real do GitHub Actions é 5) | Vendas por vendedor/canal/período/data de emissão — ver `CONTEXTO.md` |
